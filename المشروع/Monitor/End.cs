...
namespace Monitor
{
	public partial class End : Form
	{
		...
		public bool check_name_taken(string name)
		{
			...
			String selectSQL = "SELECT * from students_date where student_id=" + id + " and ((Format(student_start_datetime,'dd/MM/yyyy') = #" + Login.start_date.Value.ToString("dd/MM/yyyy") + "#)) and ((students_date.student_end_datetime) Is Null)";
		...
		public bool check_name_taken2(string name)
		{
			...
			String selectSQL = "SELECT * from teachers_date where teacher_id=" + id + " and ((Format(teacher_start_datetime,'dd/MM/yyyy') = #" + Login.start_date.Value.ToString("dd/MM/yyyy") + "#)) and ((teachers_date.teacher_end_datetime) Is Null)";
		...
		public bool check_day_today(string name)
		{
			bool ii = false;
			
			OleDbConnection con = DataBase.createConnection();

			String selectSQL = "SELECT * from students_date where student_id=" + getIDOfStudent(name) + " and ((Format(student_start_datetime,'dd/MM/yyyy') = #" + Login.start_date.Value.ToString("dd/MM/yyyy") + "#))";
		...
		public bool check_day_today2(string name)
		{
			bool ii = false;
			
			OleDbConnection con = DataBase.createConnection();

			String selectSQL = "SELECT * from teachers_date where teacher_id=" + getIDOfTeacher(name) + " and ((Format(teacher_start_datetime,'dd/MM/yyyy') = #" + Login.start_date.Value.ToString("dd/MM/yyyy") + "#))";
		...
		public void add_End_Date(string name)
		{
			if (check_name_here(name) || check_name_here2(name)) {
				
				if (check_day_today(name) || check_day_today2(name)) {
					...
					if (check_name_taken(name) || check_name_taken2(name)) {
						...
						if (check_name_here(name)) {
							...
							String insertSQL = "update students_date set student_end_datetime= '" + Login.start_date.Value.ToString("MM/dd/yyyy") + " " + DateTime.Now.ToString("HH:mm:ss") + "' where student_id = " + getIDOfStudent(name);
							...
							String insertSQL = "update teachers_date set teacher_end_datetime= '" + Login.start_date.Value.ToString("MM/dd/yyyy") + " " + DateTime.Now.ToString("HH:mm:ss") + "' where teacher_id = " + getIDOfTeacher(name);
						...
						textBox2.Invoke((MethodInvoker)delegate {
							textBox2.Text = "تم اضافة نهاية الدوام " + name;
						});
						...
						textBox2.Invoke((MethodInvoker)delegate {
							textBox2.Text = "لقد تم اضافة نهاية الدوام " + name + " مسبقا";
						});
					...
					textBox2.Invoke((MethodInvoker)delegate {
						textBox2.Text = "لم يتم تسجيل بداية الدوام " + name;
					});
			...
			try {
				...
				if (!textBox3.Text.Trim().Equals("")) {
					...
					if (check_num_here(textBox3.Text) || check_num_here2(textBox3.Text)) {
						...
						if (check_day_todayNum(textBox3.Text) || check_day_today2Num(textBox3.Text)) {
							...
							if (check_num_taken(textBox3.Text) || check_num_taken2(textBox3.Text)) {
								...
								if (check_num_here(textBox3.Text)) {
									...
									String insertSQL = "update students_date set student_end_datetime= '" + Login.start_date.Value.ToString("MM/dd/yyyy") + " " + DateTime.Now.ToString("HH:mm:ss") + "' where student_id = " + getIDOfStudentNum(textBox3.Text);
									...
									String insertSQL = "update teachers_date set teacher_end_datetime= '" + Login.start_date.Value.ToString("MM/dd/yyyy") + " " + DateTime.Now.ToString("HH:mm:ss") + "' where teacher_id = " + getIDOfTeacherNum(textBox3.Text);
								...
								textBox2.Text = "لقد تم اضافة نهاية الدوام " + textBox3.Text + " مسبقا";
							...
							textBox2.Invoke((MethodInvoker)delegate {
								textBox2.Text = "لم يتم تسجيل بداية الدوام " + textBox3.Text;
							});
		...
		public bool check_day_today2Num(string num)
		{
			bool ii = false;
			
			OleDbConnection con = DataBase.createConnection();

			String selectSQL = "SELECT * from teachers_date where teacher_id=" + getIDOfTeacherNum(num) + " and ((Format(teacher_start_datetime,'dd/MM/yyyy') = #" + Login.start_date.Value.ToString("dd/MM/yyyy") + "#))";
		...
		public bool check_day_todayNum(string num)
		{
			bool ii = false;
			
			OleDbConnection con = DataBase.createConnection();

			String selectSQL = "SELECT * from students_date where student_id=" + getIDOfStudentNum(num) + " and ((Format(student_start_datetime,'dd/MM/yyyy') = #" + Login.start_date.Value.ToString("dd/MM/yyyy") + "#))";
